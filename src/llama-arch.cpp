...
static const std::map<llm_kv, const char *> LLM_KV_NAMES = {
    ...
    { LLM_KV_MINIMAX_SPARSE_INDEX_DIM,          "%s.attention.sparse_index_dim"        },
    { LLM_KV_MINIMAX_SPARSE_INDEX_HEAD_COUNT,   "%s.attention.sparse_index_head_count" },
    { LLM_KV_MINIMAX_SPARSE_TOPK_BLOCKS,        "%s.attention.sparse_topk_blocks"      },
    { LLM_KV_MINIMAX_SPARSE_BLOCK_SIZE,         "%s.attention.sparse_block_size"       },
